...
import 'package:lab_clinica_self_service/src/modules/self_service/widget/lab_clinica_self_service_app_bar.dart';
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  Visibility(
                    visible: patientFound,
                    replacement: const Text('Cadastro não encontrado', style: LabClinicaTheme.titleSmallStyle),
                    child: const Text('Cadastro encontrado', style: LabClinicaTheme.titleSmallStyle),
                  ),
                  ...
                  TextFormField(
                    ...
                    validator: Validatorless.multiple(
                        [Validatorless.required('Email obrigatório'), Validatorless.email('Email inválido')]),
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(label: Text('Digite seu CPF')),
                  ),
                  const SizedBox(height: 16),
                  TextFormField(
                    readOnly: !enableForm,
                  ...
                  Visibility(
                    ...
                    replacement: SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          final validaded = formKey.currentState?.validate() ?? false;

                          if (validaded) {
                            if (patientFound) {
                              controller.updateAndNext(updatePatient(selfServiceController.model.patient!));
                            } else {
                              controller.registerAndNext(createPatientRegister());
                            }
                          }
                        },
                        child: Visibility(
